...
Recently I found a [tutorial](https://www.mailleartisans.org/articles/articledisplay.php?key=388) by [cliffordparker](https://www.mailleartisans.org/members/memberdisplay.php?key=1227) on [M.A.I.L.](https://www.mailleartisans.org/) that shows how to create a [Barrel](https://www.mailleartisans.org/weaves/weavedisplay.php?key=600) weave. Barrel is an interesting member of the [European]({{ site.baseurl }}{{ site.family_page }}#European) and [Rhino]({{ site.baseurl }}{{ site.family_page }}#Rhino) families with a poorly documented history. If you are curious and have large enough rings on hand, I recommend trying it out.
...
<img src="{{ site.baseurl }}{{ page.image_path }}/barrel_weave_vertical.jpg" height="500">

#### Flat

<img src="{{ site.baseurl }}{{ page.image_path }}/barrel_weave_flat.jpg" style="max-width: min(500px, 100%)">

#### In Process

<img src="{{ site.baseurl }}{{ page.image_path }}/barrel_weave_step_01.jpg" style="max-width: min(100px, 100%)">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/barrel_weave_step_02.jpg" style="max-width: min(200px, 100%)">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/barrel_weave_step_03.jpg" style="max-width: min(300px, 80%)">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/barrel_weave_step_04.jpg" style="max-width: min(400px, 90%)">
