...
date:   2023-07-02
families: European
image_path: "/assets/images/posts/2023_07_02_byzee_beez"
main_image: "/byzee_beez_flat.jpg"
image: "/assets/images/posts/2023_07_02_byzee_beez/byzee_beez_flat.jpg"
description: Join me in exploring the Byzee Beez chainmaille weave.
...
While checking out [M.A.I.L.](https://www.mailleartisans.org/) for new weaves to try out, I came across [Byzee Beez](https://www.mailleartisans.org/weaves/weavedisplay.php?key=195), submitted by [Raevyn](https://www.mailleartisans.org/members/memberdisplay.php?key=550). I found this member of the [European]({{ site.baseurl }}{{ site.family_page }}#European) family to be aesthetically pleasing, and it happened to be a derivative of [Byzantine]({{ site.baseurl }}{% post_url 2023-01-28-byzantine %}) (my favourite weave), so I decided to try and make it myself. Unfortunately, I could not find a tutorial. However, the weave is a straightforward extension of Byzantine, so I was able to make it and provide some guidance that will hopefully help you if you try to make it yourself.
...
1. First, create a 2-2-2-2-2 chain as shown in the image below.
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_tutorial_step_01.jpg" style="max-height: min(250px, 95vh)">
...
2. With your 2-2-2-2-2 chain, for each side, fold the red rings backward, then add two new rings to the now edge side between the two blue rings.
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_tutorial_step_02.jpg" style="max-height: min(250px, 95vh)">

    When you are done, it should look like this (new rings in green):

    <img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_tutorial_step_03.jpg" style="max-height: min(250px, 95vh)">
...
3. To complete your unit, add a single ring between each of the four eyes(the ones on the right are highlighted in yellow) between each red ring and its corresponding blue ring. After this, add another ring through the top and bottom pairs of the new rings you just added.
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_tutorial_step_04.jpg" style="max-height: min(250px, 95vh)">

    When done, it should look like this (first new rings in green, second new rings in blue):

    <img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_tutorial_step_05.jpg" style="max-height: min(250px, 95vh)">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_flat.jpg" style="width: min(750px, 100%)">


#### Flat: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_flat_profile.jpg" style="width: min(750px, 100%)">


#### Vertical

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_vertical.jpg" style="max-height: min(750px, 95vh)">


#### Vertical: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_vertical_profile.jpg" style="max-height: min(750px, 95vh)">


#### In Process

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_step_01.jpg" class="post-process-image-150">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_step_02.jpg" class="post-process-image-150">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_step_03.jpg" class="post-process-image-150">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/byzee_beez_step_04.jpg" class="post-process-image-150">