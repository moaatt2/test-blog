...
families:
    - European
    - Rhino
image_path: "/assets/images/posts/2024_01_07_pragyan"
main_image: "/pragyan_flat.jpg"
image: "/assets/images/posts/2024_01_07_pragyan/pragyan_flat.jpg"
description: Join me in exploring the Pragyan chainmaille weave.
tags: weave chain tutorial original aluminum
---

### Overview

In this post, I will showcase [Pragyan](https://chainmaillers.com/maillepedia/pragyan.1656/), a weave of my construction. This member of the [European]({{ site.baseurl }}{{ site.family_page }}#European) and [Rhino]({{ site.baseurl }}{{ site.family_page }}#Rhino) families is a variation of [Rover]({{ site.baseurl }}{% post_url 2023-12-31-rover %}) that I accidentally made when trying to make [Dolphin]({{ site.baseurl }}{% post_url 2023-12-24-dolphin %}). I have included a tutorial, as there are no available tutorials since this is a new weave.
...
1. Start with 1 ring through 2 rings as shown below:
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_tutorial_01.jpg" class="post-tutorial-image-300">
...
2. Add 2 new rings(green in the image below) through the 2 rings from step 1(yellow in the image below). When done, it should look something like this:
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_tutorial_02_c.jpg" class="post-tutorial-image-300">
...
3. Add 1 new ring(green in the image below) around the eye formed by the 2 rings from step 2(yellow in the image below). This ring should go through the bottom of the bottom ring of the 2 two rings from step 1(blue in the image below). When done, it should look something like this:
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_tutorial_03_c.jpg" class="post-tutorial-image-300">
...
4. Add 2 new rings(green in the image below) through the eye formed by the 2 rings from step 2(yellow in the image below). The bottom new ring should only go through those rings(no dot), while the top new ring(purple dot in the image below) should also go through the ring added in step 3(blue in the image below). When done, it should look something like this:
    ...
    <img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_tutorial_04_c.jpg" class="post-tutorial-image-300">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_flat.jpg" style="width: min(750px, 100%)">


#### Flat: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_flat_profile.jpg" style="width: min(750px, 100%)">


#### Vertical

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_vertical.jpg" style="max-height: min(750px, 95vh)">


#### Vertical: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_vertical_profile.jpg" style="max-height: min(750px, 95vh)">


#### In Process

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_step_01.jpg" class="post-process-image-150">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_step_02.jpg" class="post-process-image-150">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_step_03.jpg" class="post-process-image-150">

<br>

<img src="{{ site.baseurl }}{{ page.image_path }}/pragyan_step_04.jpg" class="post-process-image-150">
