---
layout: project_post
title:  "M.A.I.L. Weave Analysis"
date:   2023-04-16
image_path: "/assets/images/posts/2023_04_16_mail_weave_analysis"
main_image: "/relative_tag_frequency.png"
image: "/assets/images/posts/2023_04_16_mail_weave_analysis/relative_tag_frequency.jpg"
description: Join me in analyzing the distribution of weaves on M.A.I.L. by aspect ratio..
...
<img src="{{ site.baseurl }}{{ page.image_path }}/weaves-by-aspect-ratio.png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/weaves-by-aspect-ratio(single-ar).png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/weaves-by-aspect-ratio(tutorial-available).png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/weaves-by-aspect-ratio(single-ar-tutorial-available).png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/ar-pair-frequency.png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/relative_tag_frequency.png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/relative_tag_frequency(yearly).png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/num-weaves-uploaded(yearly).png">
...
<img src="{{ site.baseurl }}{{ page.image_path }}/num-weaves-uploaded(monthly).png">
