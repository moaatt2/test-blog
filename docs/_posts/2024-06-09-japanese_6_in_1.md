...
description: Join me in exploring the Japanese 6-in-1 chainmaille weave.
...
<img src="{{ site.baseurl }}{{ page.image_path }}/japanese_6_in_1_flat.jpg" style="width: min(750px, 100%)">


#### Flat: Angled

<img src="{{ site.baseurl }}{{ page.image_path }}/japanese_6_in_1_flat_angled.jpg" style="width: min(750px, 100%)">


#### Flat: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/japanese_6_in_1_flat_profile.jpg" style="width: min(750px, 100%)">


#### Vertical

<img class="post-center-image" src="{{ site.baseurl }}{{ page.image_path }}/japanese_6_in_1_vertical.jpg" style="width: min(650px, 100%)">


#### Vertical: Profile

<img class="post-center-image-mobile-only" src="{{ site.baseurl }}{{ page.image_path }}/japanese_6_in_1_vertical_profile.jpg" style="width: min(200px, 100%)">
