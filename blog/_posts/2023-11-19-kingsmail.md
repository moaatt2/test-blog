...
date:   2023-11-19
families: European
image_path: "/assets/images/posts/2023_11_19_kingsmail"
...
While looking for a new weave, I came across the historic [Kingsmail](https://www.mailleartisans.org/weaves/weavedisplay.php?key=8), also known as European 8-in-2, on [M.A.I.L.](https://www.mailleartisans.org/). This member of the [European]({{ site.baseurl }}{{ site.family_page }}#European) family  is a variant of [European 4-in-1]({{ site.baseurl }}{% post_url 2023-02-12-european_4_in_1 %}) created by doubling each ring, which can lead to a more dense and interesting weave. If you want to join me and try to make it yourself, I found this [tutorial](https://www.mailleartisans.org/articles/articledisplay.php?key=123) by [Aderamelech](https://www.mailleartisans.org/members/memberdisplay.php?key=7) helpful.
...
<img src="{{ site.baseurl }}{{ page.image_path }}/kingsmail_flat.jpg" style="width: min(750px, 100%)">


#### Flat: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/kingsmail_flat_profile.jpg" style="width: min(750px, 100%)">


#### Vertical

<img src="{{ site.baseurl }}{{ page.image_path }}/kingsmail_vertical.jpg" style="max-height: min(750px, 95vh)">


#### Vertical: Profile

<img src="{{ site.baseurl }}{{ page.image_path }}/kingsmail_vertical_profile.jpg" style="max-height: min(750px, 95vh)">
