...
<img src="{{ site.baseurl }}{{ page.image_path }}/spinal_elf_vertical.jpg" style="max-height: min(500px, 95vh)">

#### Flat

<img src="{{ site.baseurl }}{{ page.image_path }}/spinal_elf_flat.jpg" style="width: min(500px, 100%)">
